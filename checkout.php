...
<div class="checkout-layout">
  ...
  <div class="checkout-main">
    ...
    <div class="checkout-steps">
      <div class="checkout-step-tab <?= $step===1?'active':($step>1?'done':'') ?>">1. Info Email</div>
      <div class="checkout-step-tab <?= $step===2?'active':($step>2?'done':'') ?>">2. Pembayaran</div>
      <div class="checkout-step-tab <?= $step===3?'active':'' ?>">3. Akses Materi</div>
    </div>
    ...
    <div class="step-panel active" id="panel-1">
      ...
      <div class="checkout-section-title">Informasi Penerima Materi</div>
      <div class="checkout-section-sub">Ke mana link akses Tutorial Cuan harus dikirim?</div>
      ...
      <form method="POST" id="form-checkout">
        ...
        <div id="email-section" style="animation:fadeUp .3s ease both">
          <div class="form-group">
            <label class="form-label" id="email-label">Email Penerima Materi</label>
            <input class="form-control" type="email" name="email" id="email-input"
                   placeholder="nama@gmail.com" required autocomplete="email">
            <div class="form-hint" id="email-hint">Link akses semua materi Tutorial Cuan akan dikirim ke alamat email ini</div>
          </div>
    ...
    <div class="step-panel active" id="panel-3">
      ...
      <div class="payment-success">
        ...
        <p style="color:var(--c-text-sec);margin-bottom:24px">
          Terima kasih! Semua materi Tutorial Cuan telah dikirim ke email Anda. Selamat mulai earning!
        </p>
  ...
  <div class="checkout-summary">
    ...
    <div class="order-product">
      ...
      <div>
        <div class="order-product__name">Tutorial Cuan Harian</div>
        <div class="order-product__dur">Apk + Web + Video VIP + PDF Panduan</div>
      </div>
    </div>

    <div class="order-line">
      <span class="order-line__label">Harga paket lengkap</span>
      <span class="order-line__value"><?= $priceStr ?></span>
    </div>
    <div class="order-line">
      <span class="order-line__label">Bonus materi eksklusif</span>
      <span class="order-line__value" style="color:var(--c-green)">Gratis</span>
    </div>
    <div class="order-line">
      <span class="order-line__label">Update seumur hidup</span>
      <span class="order-line__value" style="color:var(--c-green)">Gratis</span>
    </div>
    <div class="order-line">
    ...
    <div class="checkout-trust">
      ...
      <div class="checkout-trust-item">
        ...
        Materi dikirim langsung ke email Anda
      </div>
      <div class="checkout-trust-item">
    ...
    <div class="guarantee-badge">
      ...
      <div><div class="guarantee-badge__title">Garansi Profit Hari Pertama</div><div class="guarantee-badge__text">Jika tidak profit di hari pertama mengikuti panduan, kami kembalikan uang Anda 100%.</div></div>
    </div>
